...
\begin{eqnarray}
  \frac{d}{dt} \Bigl\{ \frac{\partial \bigl(T-U\bigr)}{\partial \dot{q}} \Bigr\} - \frac{\partial \Bigl(T-U\Bigr)}{\partial q} &=& 0
  \\
  \nonumber\\
   \frac{d}{dt} \Bigl( \frac{\partial T}{\partial \dot{q}} - \frac{\partial U}{\partial \dot{q}} \Bigr) - \Bigl( \frac{\partial T}{\partial q} - \frac{\partial U}{\partial q} \Bigr) &=& 0
\end{eqnarray}
...
以上より、
\begin{eqnarray}
    \frac{d}{dt} \Bigl( \frac{\partial T}{\partial \dot{q}} \Bigr) - \frac{d}{dt} \Bigl( \frac{\partial U}{\partial \dot{q}} \Bigr) + \frac{\partial U}{\partial q} = 0
    \\
    \nonumber\\
    \frac{d}{dt} \Bigl( \frac{\partial T}{\partial \dot{q}} \Bigr) = \frac{d}{dt} \Bigl( \frac{\partial U}{\partial \dot{q}} \Bigr) - \frac{\partial U}{\partial q}
\end{eqnarray}
...
そして、運動量$p$は以下のように求まる。
\begin{equation}
  p = \frac{\partial L}{\partial \dot{q}} = mv + q \bm{A}\\
\end{equation}
